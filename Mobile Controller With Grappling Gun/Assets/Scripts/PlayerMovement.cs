...
public class PlayerMovement : MonoBehaviour
{
    ...
    private float sensMultiplier = 3f;
    ...
    private void MyInput()
    {
        ...
        x = UltimateJoystick.GetHorizontalAxis("movement");
        y = UltimateJoystick.GetVerticalAxis("movement");
    ...
    private void Look()
    {
        ...
        float mouseX = UltimateJoystick.GetHorizontalAxis("camera") * sensitivity * Time.deltaTime * sensMultiplier;
        float mouseY = UltimateJoystick.GetVerticalAxis("camera") * sensitivity * Time.deltaTime * sensMultiplier;
